 ...
 */
export default function PolaroidFlipCard(props: Props) {
    const {
                    ...
                    >
                        <p
                            style={{
                                ...
                                lineHeight: 1.5,
                                fontSize: 20,
                                ...(noteFont && typeof noteFont === "object"
                                    ? noteFont
                                    : {}),
                                color: noteColor,
                            }}
